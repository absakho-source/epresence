# COURRIER DE DÉCLARATION DE TRAITEMENT DE DONNÉES PERSONNELLES
...
**Sicap Sacré Cœur III, Villa N°8252**
**Dakar – Sénégal**
...
- Faciliter la collecte et l'archivage des données de présence
- Améliorer la traçabilité et la fiabilité des listes de présence
- Réduire l'utilisation du papier conformément aux objectifs de développement durable

## III. CATÉGORIES DE DONNÉES COLLECTÉES

Dans le cadre de ce traitement, les données suivantes sont collectées :

### A. Données d'identification des participants
- Nom et prénom
- Adresse email professionnelle
- Numéro(s) de téléphone (principal et secondaire)
- Fonction ou poste occupé
- Structure ou direction d'appartenance

### B. Données de signature électronique
- Signature manuscrite numérisée (image)
...
- **Feuilles d'émargement actives :** Pendant la durée de l'événement
- **Feuilles d'émargement clôturées :** 5 ans à compter de la date de clôture (conformément aux archives administratives)
- **Comptes utilisateurs :** Pendant la durée d'activité de l'agent + 1 an
- **Données de connexion (logs) :** 1 an maximum

Au-delà de ces délais, les données font l'objet d'une suppression sécurisée ou d'un archivage légal selon les cas.
...
- Contrôle d'accès strict basé sur les rôles utilisateurs
...
- Sensibilisation du personnel au respect de la confidentialité

## VIII. DROITS DES PERSONNES CONCERNÉES

Conformément à la loi n° 2008-12, les personnes dont les données sont collectées disposent des droits suivants :
...
À ce jour, aucun transfert de données personnelles vers des pays tiers n'est prévu. L'hébergement et le traitement des données s'effectuent exclusivement sur le territoire national ou sur des serveurs respectant les normes internationales de protection des données (en cas d'hébergement cloud conforme).

---

En vous priant de bien vouloir enregistrer cette déclaration et de nous délivrer le récépissé prévu par la réglementation, je vous prie de croire, Monsieur le Président, à l'assurance de ma considération distinguée.
...
**Pièces jointes :**
- Formulaire de déclaration dûment rempli (modèle CDP)
- Note technique du système e-Présence
- Politique de confidentialité du système
...
**Contact technique pour suivi :**
Nom : __________________________
Fonction : Responsable du système e-Présence
